...
public class mindshaftConfig  {
    ...
    @Config.Comment({"Manually specify minimap zoom level without using in-game key bindings", "Default zoom levels:","0: 192 blocks across.","1: 128 blocks across.","2: 64 blocks across.","3: 32 blocks across."})
    @RangeInt(min=0, max=255)
    @Name("Current zoom level")
    public static int zoom = 3;
    
    @Config.Comment({"Manually specify fullscreen map zoom level without using in-game key bindings", "Default zoom levels:","0: 192 blocks across.","1: 128 blocks across.","2: 64 blocks across.","3: 32 blocks across."})
    @RangeInt(min=0, max=255)
    @Name("Current fullscreen zoom level")
    public static int zoomfs = 3;

    @Config.Comment({"Base rate for layer processing per tick, divided by current zoom level.", "ex: 384 (default rate) / 192 (default largest zoom level) = 2 layers per tick." , "Higher values result in greater rendering performance impact but faster update responsiveness.", "If you experience stuttering, lower this value and/or use smaller zoom levels."})
    ...
    @Config.Comment({"The minimap edge is offset this far from the edge of the screen.", "Expressed as percentage of horizontal screen width.","0 is flush to edge.", "Has no effect on the fullscreen map."})
    ...
    @Config.Comment({"The minimap edge is offset this far from the edge of the screen.", "Expressed as percentage of vertical screen width.", "0 is flush to edge.",  "Has no effect on the fullscreen map."})
    @RangeInt(min=0,max=100)
